...
class History extends Component {
  constructor() {
    ...
    this.getTodayPrice = this.getTodayPrice.bind(this);
    this.getYesterdayPrice = this.getYesterdayPrice.bind(this);
    this.getTwoDaysPrice = this.getTwoDaysPrice.bind(this);
    this.getThreeDaysPrice = this.getThreeDaysPrice.bind(this);
    this.getFourDaysPrice = this.getFourDaysPrice.bind(this);
  }
